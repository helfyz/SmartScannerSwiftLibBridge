...
public protocol EditImageViewDelegate: NSObjectProtocol {
...
public final class EditImageViewController: UIViewController {
    ...
    public var quadModel: SSQuadrilateralModel
    ...
    public init(image: UIImage, quadModel: SSQuadrilateralModel?, rotateImage: Bool = true, strokeColor: CGColor? = nil) {
        self.image = rotateImage ? image.applyingPortraitOrientation() : image
        self.quadModel = quadModel ?? EditImageViewController.defaultQuad(allOfImage: image)
    ...
    public func cropImage() {
        ...
        self.quadModel = SSQuadrilateralModel(quad: scaledQuad)
    ...
    public func allQuad() {
        let newQuad = EditImageViewController.defaultQuad(allOfImage: self.image)
        quadModel = newQuad
        adjustQuadViewConstraints()
        displayQuad()
    }
    public func resetQuad(quadModel: SSQuadrilateralModel) {
    ...
    private static func defaultQuad(allOfImage image: UIImage, withOffset offset: CGFloat = 75) -> SSQuadrilateralModel {
...
extension EditImageViewController:UIGestureRecognizerDelegate {
    ...
    public func gestureRecognizer(_ gestureRecognizer: UIGestureRecognizer, shouldReceive touch: UITouch) -> Bool {
        let cornerView = self.quadView.cornerViewFor(point: touch.location(in: self.quadView))
        if cornerView != nil {
            return true
        }
        return false
