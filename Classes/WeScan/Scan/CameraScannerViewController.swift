...
public final class CameraScannerViewController: UIViewController {
    ...
    @objc public func continueCapture() {
        captureSessionManager?.start()
    }
    ...
    public func changeCaptureMode(_ mode: CaptureSessionMode) {
        captureSessionManager?.mode = mode
    }
    
    @objc public func removeQuadrilateral() {
        quadView.removeQuadrilateral()
    }
...
extension CameraScannerViewController: RectangleDetectionDelegateProtocol {
    ...
    func captureSessionManager(_ captureSessionManager: CaptureSessionManager,
        ...
        guard let quad = quad else {
            ...
            quadView.removeQuadrilateral()
            delegate?.captureImageWaiting(wait: true)
            return
        }
        ...
        delegate?.captureImageWaiting(wait: false)
    }
